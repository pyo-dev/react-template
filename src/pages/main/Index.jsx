	...
	return (
		<div className="lm-panel-vertical">
			<div className="lm-dashboard-wrap">
				<div className="lm-panel icon-pos" onClick={()=> goNav(`/pyo-dev/design`)}>
				...
				<div className="lm-panel icon-pos" onClick={()=> goNav(`/pyo-dev/filter`)}>
				...
				<div className="lm-panel icon-pos" onClick={()=> goNav(`/pyo-dev/loader`)}>
				...
				<div className="lm-panel icon-pos" onClick={()=> goNav(`/pyo-dev/react`)}>
